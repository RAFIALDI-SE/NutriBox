<nav class="navbar fixed-top shadow navbar-expand-lg navbar-light bg-light mt-lg-4 rounded-pill">
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link px-5 btn btn-primary rounded-pill text-white" href="/admin/login">Login</a>
            </li>
        </ul>
        </div>
    </div>
