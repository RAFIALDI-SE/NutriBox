    ...
    <div class="container mt-lg-5 py-5">
        <div class="row pt-lg-5">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <span class="h4 me-2">Rp {{ number_format($product->price,0,',','.') }}</span>
                    <span class="text-muted"><s>Rp {{ number_format($product->saleprice,0,',','.') }}</s></span>
                </div>
               <a href="https://wa.me/62895621139868?text={{ urlencode('Halo min, saya ingin memesan menu '.$product->title) }}" 
   target="_blank" 
   class="btn btn-success btn-lg mb-3 me-2">
